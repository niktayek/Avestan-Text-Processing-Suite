...
CSV_OUT = os.path.join(OUT_DIR, 'stanza_word_matches_0005_by_our_tight.csv')
...
# Run aligner with tighter parameters
ratio_threshold = 0.75
window = 2
max_canon_span = 3
results = ms.match_stanzas(CANON, OURS, out_path=None, limit=None, window=window, ratio_threshold=ratio_threshold, max_canon_span=max_canon_span)
